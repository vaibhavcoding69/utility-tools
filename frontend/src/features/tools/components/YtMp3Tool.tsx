...
export function YtMp3Tool() {
  ...
  const handleConvert = async () => {
    ...
    try {
      const result = await api.convertYtToMp3(url);
      if (result.success) {
      ...
      <div className="tool-header">
        <h2 className="tool-title">
          <span className="tool-title-icon">
            <i className="bi bi-music" />
          </span>
          YouTube to MP3
        </h2>
        <p className="tool-description">
          Convert YouTube videos to MP3 audio format. Download music in high quality from any YouTube video.
        </p>
      </div>
        ...
        {videoInfo && (
          <div className="video-preview-card">
            ...
            <div className="video-preview-info">
              ...
              {videoInfo.duration && (
                <p className="video-preview-duration">
