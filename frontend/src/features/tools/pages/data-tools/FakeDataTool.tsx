...
export function FakeDataTool() {
  ...
  const dataTypes = ['person', 'address', 'company', 'email', 'phone', 'date', 'text']
  ...
  return (
    <div className="tool-container">
      <div className="tool-header">
        ...
        <p className="tool-description">Generate fake test data for development</p>
      </div>
      <div className="tool-content">
        <div className="tool-options">
          <div className="tool-option">
            <label className="tool-label">Data Type</label>
            <select className="tool-select" value={dataType} onChange={(e) => setDataType(e.target.value)}>
              {dataTypes.map((type) => (
